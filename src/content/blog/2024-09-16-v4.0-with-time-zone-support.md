...
I also have [Interim API](https://github.com/date-fns/interim) [experiment in work](https://x.com/kossnocorp/status/1778923173792379274), a lightweight Temporal API subset, to help developers start using it now and when it's time to migrate—simply find-and-replace class names or imports.
